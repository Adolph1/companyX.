...
<script>
    ...
    function loadPlans() {
        var id = document.getElementById("property-id").value;

       // alert(id);
        $.get("<?php echo Yii::$app->urlManager->createUrl(['plan/load-all', 'id' => '']);?>" + id, function (data) {
          //  alert(data);

            document.getElementById("months-ids").innerHTML = data;
